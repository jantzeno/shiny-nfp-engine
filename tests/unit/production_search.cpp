...
TEST_CASE("public strategies conserve layouts under limits and cancellation",
  ...
  struct StrategyCase {
    StrategyKind strategy{StrategyKind::sequential_backtrack};
    shiny::nesting::ProductionOptimizerKind optimizer{
        shiny::nesting::ProductionOptimizerKind::brkga};
  };

  const std::array cases{
      StrategyCase{.strategy = StrategyKind::sequential_backtrack},
      ...
      StrategyCase{
          ...
          .optimizer =
              shiny::nesting::ProductionOptimizerKind::simulated_annealing},
      StrategyCase{.strategy = StrategyKind::metaheuristic_search,
                   .optimizer = shiny::nesting::ProductionOptimizerKind::alns},
      StrategyCase{.strategy = StrategyKind::metaheuristic_search,
                   .optimizer = shiny::nesting::ProductionOptimizerKind::gdrr},
      StrategyCase{.strategy = StrategyKind::metaheuristic_search,
                   .optimizer = shiny::nesting::ProductionOptimizerKind::lahc},
      StrategyCase{.strategy = StrategyKind::simulated_annealing},
      StrategyCase{.strategy = StrategyKind::alns},
      StrategyCase{.strategy = StrategyKind::gdrr},
      StrategyCase{.strategy = StrategyKind::lahc},
  };
