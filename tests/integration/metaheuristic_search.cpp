...
TEST_CASE("mtg metaheuristic-search positive matrix places every part",
...
TEST_CASE("mtg metaheuristic-search optimizer breadth places every part",
          "[mtg][nesting-matrix][metaheuristic-search][.][slow]") {
  const auto fixture = make_asymmetric_engine_surface_fixture();
...
TEST_CASE("mtg metaheuristic-search explore_concave_candidates still places every part",
