...
target("shiny_nesting_engine_tests")
    ...
    add_files("tests/integration/mtg_section_a_bin_assignment.cpp")
    add_files("tests/integration/mtg_section_b_start_corners.cpp")
    add_files("tests/integration/mtg_section_c_bb_heuristics.cpp")
    add_files("tests/integration/mtg_section_d_irregular_constructive.cpp")
    add_files("tests/integration/mtg_section_e_production_optimizers.cpp")
    add_files("tests/integration/mtg_section_f_sliders.cpp")
    add_files("tests/integration/mtg_section_g_limits.cpp")
    add_files("tests/integration/mtg_section_h_seeds.cpp")
    add_files("tests/integration/mtg_section_i_margins.cpp")
    add_files("tests/integration/mtg_section_j_exclusion.cpp")
    add_files("tests/integration/mtg_engine_bug_repros.cpp")
    add_files("tests/integration/mtg_section_k_engine_surface.cpp")
