...
target("shiny_nfp_engine_profile_decode_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/profile_decode_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_genetic_search_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/genetic_search_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_jostle_search_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/jostle_search_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_jostle_search_scaling_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/jostle_search_scaling_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_convex_nfp_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/convex_nfp_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_nonconvex_nfp_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/nonconvex_nfp_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_nonconvex_nfp_cached_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/nonconvex_nfp_cached_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_masonry_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/masonry_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_orbital_verifier_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/scenarios/orbital_verifier_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()

target("shiny_nfp_engine_decomposition_benchmark")
    set_kind("binary")
    add_deps("shiny_nfp_engine")
    add_files("benchmarks/micro/decomposition_smoke.cpp")
    add_vendor_warning_suppression_flags()
    add_thread_support_flags()
    add_sanitizer_compile_flags()
    add_sanitizer_link_flags()
