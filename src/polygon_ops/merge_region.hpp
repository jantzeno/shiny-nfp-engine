 ...
 */
[[nodiscard]] auto make_merged_region(const geom::PolygonWithHoles &polygon)
    -> MergedRegion;

/**
 * @brief Merges two polygons into one merged-region accumulator.
 */
[[nodiscard]] auto merge_region(const geom::PolygonWithHoles &lhs,
 ...
 */
[[nodiscard]] auto
merge_polygon_into_region(const MergedRegion &region,
