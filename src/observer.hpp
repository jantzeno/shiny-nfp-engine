...
struct ProgressSnapshot {
  ...
  std::size_t placements_successful{0};
  std::size_t total_requested_parts{0};
...
public:
  explicit ProgressThrottle(std::uint64_t min_interval_ms = kDefaultIntervalMs)
