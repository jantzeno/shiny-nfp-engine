 ...
 */
[[nodiscard]] auto union_polygons(const PolygonWithHoles &lhs,
 ...
 */
[[nodiscard]] auto intersection_polygons(const PolygonWithHoles &lhs,
                                         const PolygonWithHoles &rhs)
    -> std::vector<PolygonWithHoles>;
 ...
 */
[[nodiscard]] auto difference_polygons(const PolygonWithHoles &lhs,
                                       const PolygonWithHoles &rhs)
    -> std::vector<PolygonWithHoles>;
 ...
 */
[[nodiscard]] auto polygon_distance(const PolygonWithHoles &lhs,
 ...
 */
[[nodiscard]] auto buffer_polygon(const PolygonWithHoles &polygon,
                                  double distance)
    -> std::vector<PolygonWithHoles>;
